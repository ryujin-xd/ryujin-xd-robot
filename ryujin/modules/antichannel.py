...
from ryujin.modules.helper_funcs.decorators import ryujincmd, ryujinmsg
from ryujin.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from ryujin.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@ryujincmd(command="antichannelmode", group=100)
...
@ryujinmsg(Filters.chat_type.groups, group=110)
